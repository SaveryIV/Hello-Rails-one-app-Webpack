...
```bash
  git clone https://github.com/SaveryIV/Hello-Rails-one-app-Webpack.git
```
...
```bash
  cd Hello-Rails-one-app-Webpack
  bundle install
```
...
Feel free to check the [issues page](https://github.com/SaveryIV/Hello-Rails-one-app-Webpack/issues).
